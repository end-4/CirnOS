    ...
    settings = {
      ...
      bind =
        ...
        in [
          ...
          "Super, B, exec, ags -b hypr -t 'sideleft'"
          "Super, A, exec, ags -b hypr -t 'sideleft'"
          "Super, O, exec, ags -b hypr -t 'sideleft'"
          "Super, N, exec, ags -b hypr -t 'sideright'"
          "Super, M, exec, ags -b hypr run-js 'openMusicControls.value = (!Mpris.getPlayer() ? false : !openMusicControls.value);'"
          "Super, Comma, exec, ags -b hypr run-js 'openColorScheme.value = true; Utils.timeout(2000, () => openColorScheme.value = false);'"
          "Super, K, exec, ags -b hypr -t 'osk'"
      ...
      bindl = [
        ...
        ", XF86AudioMute, exec, ags -b hypr run-js 'indicator.popup(1);'"
        "Super+Shift,M,   exec, ags -b hypr run-js 'indicator.popup(1);'"
      ];
      bindle = [
        ",XF86AudioRaiseVolume, exec, wpctl set-volume -l 1 @DEFAULT_AUDIO_SINK@ 5%+"
        ",XF86AudioLowerVolume, exec, wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-"
        ",XF86MonBrightnessUp, exec, ags -b hypr run-js 'brightness.screen_value += 0.05;'"
        ",XF86MonBrightnessDown, exec, ags -b hypr run-js 'brightness.screen_value -= 0.05;'"
        ",XF86AudioRaiseVolume, exec, ags -b hypr run-js 'indicator.popup(1);'"
        ",XF86AudioLowerVolume, exec, ags -b hypr run-js 'indicator.popup(1);'"
        ",XF86MonBrightnessUp, exec, ags -b hypr run-js 'indicator.popup(1);'"
        ",XF86MonBrightnessDown, exec, ags -b hypr run-js 'indicator.popup(1);'"
